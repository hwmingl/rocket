...
/**
 * TCP socket configuration contains configuration for main server channel and
 * client channels
 * 
 * @author Von Gosling
...
public class SocketConfig {
    ...
    private int     tcpSendBufferSize    = -1;    // see /proc/sys/net/ipv4/tcp_rmem
    private int     tcpReceiveBufferSize = -1;    // see /proc/sys/net/ipv4/tcp_wmem
